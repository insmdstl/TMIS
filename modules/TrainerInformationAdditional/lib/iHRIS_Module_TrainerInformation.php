...
class iHRIS_Module_TrainerInformation extends I2CE_Module {

  
    public static function getMethods() {
        return array(
            'iHRIS_PageView->action_trainer_information' => 'action_trainer_information'
            );
    }


    public function action_trainer_information($obj) {
        if (!$obj instanceof iHRIS_PageView) {
            return;
        }
        return $obj->addChildForms('trainer_information', 'siteContent');
    }
    ...
    protected function pre_migrate() {
        ...
        I2CE_FormStorage::storeMigrateData( array( "provider_instance" => array( "trainer_information" ) ), $migrate_path );
    ...
    protected function migrate() {
        ...
        $migrate_path = "/I2CE/formsData/migrate_data/4.1.8";
        if ( !I2CE_FormStorage::migrateForm( "trainer_information", "entry", $user, $migrate_path ) ) {
            return false;
        }
        if ( I2CE_ModuleFactory::instance()->isEnabled("CachedForms") ) {
            $cachedForm = new I2CE_CachedForm( "trainer_information" );
            $cachedForm->dropTable();
        }
        if ( !I2CE_FormStorage::migrateField( "provider_instance", array( "trainer_information" => "trainer_information"),
                    $migrate_path, $user ) ) {
            return false;
        }
        return true;
