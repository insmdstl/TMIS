...
class iHRIS_Module_TrainingArea extends I2CE_Module {

  
    public static function getMethods() {
        return array(
            'iHRIS_PageView->action_training_area' => 'action_training_area'
            );
    }
    ...
    public function action_training_area($obj) {
        ...
        return $obj->addChildForms('training_area', 'siteContent');
    }
    ...
    protected function pre_migrate() {
        ...
        I2CE_FormStorage::storeMigrateData( array( "training" => array( "training_area" ) ), $migrate_path );
    ...
    protected function migrate() {
        ...
        $migrate_path = "/I2CE/formsData/migrate_data/4.1.8";
        if ( !I2CE_FormStorage::migrateForm( "training_area", "entry", $user, $migrate_path ) ) {
            return false;
        }
        if ( I2CE_ModuleFactory::instance()->isEnabled("CachedForms") ) {
            $cachedForm = new I2CE_CachedForm( "training_area" );
            $cachedForm->dropTable();
        }
        if ( !I2CE_FormStorage::migrateField( "training", array( "training_area" => "training_area" ),
                    $migrate_path, $user ) ) {
            return false;
        }
        return true;
